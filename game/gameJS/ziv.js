...
class Ziv {
    ...
    draw() {
        ...
        push();
            ...
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 7.6, this.size * 3, this.size * 1.5, radians(15), radians(90));
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 9.1, this.size * 6, this.size * 3, radians(15), radians(90));
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 10.6, this.size * 8, this.size * 4.5, radians(15), radians(90));
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 6.1, this.size * 8, this.size * 4.5, radians(180), radians(270));
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 6.1, this.size * 5, this.size * 3, radians(180), radians(270));
            arc(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 6.1, this.size * 2, this.size * 1.5, radians(180), radians(270));

            line(this.body.position.x - this.size * 2.5, this.body.position.y - this.size * 4.5, 
                this.body.position.x - this.size * 2.5, this.body.position.y - this.size * 6.1);
            line(this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 4.5, 
                this.body.position.x + this.size * 2.5, this.body.position.y - this.size * 6.1);

            arc(this.body.position.x - this.size * 2.05, this.body.position.y - this.size * 4.575, this.size * 3, this.size * 1.5, radians(280), radians(350));
            arc(this.body.position.x + this.size * 2.05, this.body.position.y - this.size * 4.575, this.size * 3, this.size * 1.5, radians(190), radians(260));

            push();
                strokeWeight(this.thick * 2 / 1.7 * 1.2);
                point(this.body.position.x - this.size * 0.85, this.body.position.y - this.size * 4.8);
                point(this.body.position.x + this.size * 0.85, this.body.position.y - this.size * 4.8);
            pop();
